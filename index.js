...
// Wczytanie credentials Firebase
...
app.post("/verifyDevice", async (req, res) => {
    ...
    try {
        // Sprawdzenie, czy użytkownik istnieje w Firebase Auth
        try {
        ...
        // Nowy użytkownik – rejestracja HWID
        if (!doc.exists) {
            await userRef.set({
                deviceId: deviceId,
        ...
        // Brak deviceId w dokumencie – rejestracja
